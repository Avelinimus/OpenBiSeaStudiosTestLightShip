...
namespace Game.Utils
{
    public class TimerDelayer : IDisposable
    {
        ...
        private class DelayItem<T0, T1, T2> : IDelayItem
        {
            ...
            public DelayItem(float delay, Action<T0, T1, T2> action, object argument0, object argument1,
                object argument2)
            {
                ActionTime = Time.time + delay;
                _action = action;
        ...
        public void DelayAction<T0, T1, T2>(float delay, Action<T0, T1, T2> action, object arg0, object arg1,
            object arg2)
        {
