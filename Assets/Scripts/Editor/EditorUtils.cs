...
namespace Game.Editor
{
    public class EditorUtils
    {
        ...
        private readonly static Stack<bool> _enableStack = new Stack<bool>();
        ...
        {
            GUILayout.BeginHorizontal();
            if (selected) EditorGUILayout.BeginHorizontal(GUILayout.MinHeight(10f));
        ...
        public static int UpDownArrows(GUIContent label, int value, GUIStyle labelStyle, GUIStyle upArrow, GUIStyle downArrow)
        {
            ...
            {
                upArrow = GUI.skin.FindStyle("DailyAchievementsDailyAchievementsBtn");
                downArrow = upArrow;
            }
        ...
        public class Styles
        {
            ...
            public static readonly string Tag_TextField_Button = "Tag TextField DailyAchievementsDailyAchievementsBtn";
